...
# I/O row (y=112)
circ("VOCT", 7.5, 112, D_JACK, "#224444")
circ("TRIG", 19.0, 112, D_JACK, "#224444")
circ("OUT", 34.0, 112, D_JACK, "#442222")
circ("SPK", 45.5, 112, D_JACK, "#442222")
circ("W", 56.0, 112, D_JACK, "#442222")

ax.set_xlim(-2, W + 2); ax.set_ylim(H + 2, -2); ax.set_aspect("equal"); ax.axis("off")
ax.set_title("Axon 12HP — FHN phase-portrait display", fontsize=8)
